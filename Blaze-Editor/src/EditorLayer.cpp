...
namespace Blaze {
	...
	void EditorLayer::OnAttach()
	{
		...
		Blaze::FramebufferSpecification fbSpec;
		fbSpec.Width = 1280;
		fbSpec.Height = 720;
		m_Framebuffer = Blaze::Framebuffer::Create(fbSpec);
	}
	...
	void EditorLayer::OnUpdate(Blaze::Timestep ts)
	{
		BZ_PROFILE_FUNCTION();
	...
	void EditorLayer::OnImGuiRender()
	{
		...
		if (ImGui::BeginMenuBar())
		{
			if (ImGui::BeginMenu("File"))
			{
				...
				if (ImGui::MenuItem("Exit")) Blaze::Application::Get().Close();
				ImGui::EndMenu();
			}
	...
	void EditorLayer::OnEvent(Blaze::Event& e)
	{
