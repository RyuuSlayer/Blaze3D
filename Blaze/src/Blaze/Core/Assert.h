...
namespace Blaze::Assert
{
	...
	#define BZ_INTERNAL_ASSERT_NO_MSG(type, check) BZ_INTERNAL_ASSERT_IMPL(type, check, "Assertion '{0}' failed at {1}:{2}", BZ_STRINGIFY_MACRO(check), ::Blaze::Assert::CurrentFileName(__FILE__), __LINE__)
